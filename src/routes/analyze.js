...
حساب درجة الثقة (confidence) — هذا الرقم يجب أن يتغيّر فعلياً من صفقة لأخرى حسب هذه المعايير بالضبط، لا ترجع رقماً ثابتاً أبداً:
- ابدأ من 50 كنقطة أساس.
- أضف حتى +20 إذا كانت أرقام محور السعر (الدعم/المقاومة) واضحة ومقروءة تماماً بالصورة. اخصم حتى -20 إذا كانت غير واضحة أو غير موجودة.
- أضف حتى +15 إذا كان النمط الفني كلاسيكي وواضح الشكل (مثل رأس وكتفين واضح، أو قناة سعرية منتظمة). اخصم حتى -15 إذا كانت حركة السعر عشوائية بدون نمط واضح.
- أضف حتى +15 إذا اتفقت كل الفريمات المرفوعة على نفس الاتجاه. اخصم حتى -15 إذا تعارضت الفريمات مع بعضها.
- أضف حتى +10 إذا وُجدت مؤشرات فنية مرسومة تدعم القراءة (RSI متطرف، تقاطع متوسطات). لا تضف شيء إن لم توجد مؤشرات.
- الناتج النهائي رقم بين 15 و95 فقط — لا تستخدم أبداً نفس الرقم بين تحليلين مختلفين إلا لو كانت المعايير متطابقة فعلياً بالصدفة.
...
أجب فقط بكائن JSON صالح بالضبط، بدون أي نص إضافي ولا Markdown:
{
  ...
  "confidence_reasoning": "جملة قصيرة توضح سبب هذا الرقم تحديداً (مثلاً: خُصم بسبب تعارض فريم الساعة مع فريم اليوم)",
