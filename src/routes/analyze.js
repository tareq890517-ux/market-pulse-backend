...
حلّل الصورة وأجب فقط بكائن JSON صالح بالصيغة التالية بالضبط، بدون أي نص إضافي ولا Markdown:
{
  ...
  "entry": "سعر دخول مقترح بناءً على النمط والمستويات",
  "stop_loss": "سعر وقف الخسارة المقترح (لو تحرك السعر عكس الاتجاه)",
  "take_profit": "سعر جني الأرباح المقترح (أقرب هدف واقعي)",
  "risk_level": "منخفضة أو متوسطة أو عالية، حسب وضوح النمط وقرب المستويات وتقلب السعر",
  "risk_reward": "نسبة تقريبية بصيغة مثل 1:2.5",
  "risk_reward_label": "good أو warn أو bad حسب جودة النسبة",
  "confidence": "درجة ثقة النمط كنسبة مئوية تقريبية (ثقة في وضوح النمط، وليست نسبة نجاح الصفقة)",
  "risk_factors": ["عامل خطر أول", "عامل خطر ثاني", "عامل خطر ثالث إن وجد"]
}
مهم جداً: لا تخترع أي نسبة "احتمال نجاح الصفقة" — هذا رقم لا يمكن حسابه فعلياً من صورة واحدة. اكتفِ بمستويات دخول/خروج واضحة، درجة خطورة عامة، ودرجة ثقة بالنمط الفني فقط.
